...
function deniedMessage(role: RoleName): string {
  switch (role) {
    case "waiter":
      return "Tu perfil de mesero solo incluye Restaurante y Punto de venta (tomar pedidos). No incluye Ventas, Caja, Cocina ni administración.";
    case "cook":
      return "Tu perfil de cocina solo incluye la pantalla Cocina (KDS).";
    case "cashier":
      return "Tu perfil de cajero incluye Restaurante, Ventas, Caja registradora y Punto de venta. El resto de secciones las gestiona un supervisor o administrador.";
    default:
